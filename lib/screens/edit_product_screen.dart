    ...
    if(_isInit){
      ...
      if(productId != null ){ 
        ...
        _initValue = {
          ...
          // 'imageUrl': _editedProduct.imageUrl, // cause problem
          'imageUrl': '', //solution
        };
        _imageUrlController.text = _editedProduct.imageUrl; //solution
      }
    }
    _isInit = false;
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: TextFormField(
                      // initialValue: _initValue['imageUrl'], don't use both controller an initial value here
